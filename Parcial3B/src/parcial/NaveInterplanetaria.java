...
public class NaveInterplanetaria implements NaveEspacial {
 private double peso;
 private double capacidad;
 private double velocidadMaxima;
 private String sistemaPropulsion;

 public NaveInterplanetaria(double peso, double capacidad, double velocidadMaxima, String sistemaPropulsion) {
     this.peso = peso;
